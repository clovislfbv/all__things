...
allowed_channels = [796137851972485151, 697492398070300763, 796731890630787126, 631935311592554636, 1074028461338923100] #["🤖・cow-bip-bop-bots", "bruh-botsandmusic", "test-bot", "général de mon propre serveur"]
...
class OtherCommands(commands.Cog):
    ...
    async def say(self, ctx, chiffre, *texte):
        ...
        if int(chiffre) > 100:
            await ctx.send("dsl j'ai été patch je peux plus faire plus de 100 messages")
        else:
